...
<tr >   <td colspan="2" align="left">Номер отображения <input type="text" name="num" size="3" maxlength="3" value="{num}"></td>

</tr>

<tr>
<td align="left" colspan="2">Только для зарегистрированных пользователей <input type="checkbox" name="reg" id="reg" value="1" {reg}></td>
</tr>
<tr>
<td align="left" colspan="2">Использовать позиции из категории в случайных фото <input type="checkbox" name="rand" id="rand" value="1" {rand}></td>
</tr>
<tr>
<td align="left" colspan="2">
Картинка для категории (300 x * пикселей) формат *.jpg
</td>
</tr>
<tr>
<td align="center">
